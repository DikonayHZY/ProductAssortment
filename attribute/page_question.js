		...
		<div style="width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center;">
			<div style="width: 100%; height: 25%; display: flex; align-items: center; justify-content: center;"><!-- 题目说明 -->
				<div style="width: 60%; height: 100%; display: flex; align-items: center; justify-content: center; font-size: 24px; line-height: 2; text-align: center;">
					<p>
						接下来是本环节的问卷部分<br>
						请<strong>认真阅读题目要求</strong><br>
						有些题与本实验展示的产品无关，有些题则需要你回忆实验流程</br>
						回答不限时，一旦进入“下一题”就不能返回更改，请根据真实感受认真作答<br>					
					</p>
				</div>			
			</div>
			<div style="width: 100%; height: 20%; display: flex; align-items: center; justify-content: center;">
				<a id="next_tips" href="#" style="width: 200px; height: 40px; border: 2px solid black; text-align: center; font-size: 26px;/*visibility: hidden*/;">开始作答</a>
			</div>				
		</div>
	</div>	
`;