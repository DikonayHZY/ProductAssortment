		...
		<div style="width: 100%; height: 80%; display: flex; align-items: center; background:url(../resource/1.jpg); background-size: 100% 100%; background-repeat:no-repeat;"> <!-- 下半部分 -->
			<div style="width: 100%; height: 70%; background-color: rgba(0,0,0,0.8); display: flex; flex-direction: column; justify-content: center;">
				...
				<div class="shampoo_main_menu" style="width: 100%; height: 40%; display: flex; align-items: center; justify-content: center; color: white; font-size: 40px;">
					<a href="#" id="green_tea_main">牙刷1</a>&emsp;<span class="line">&#124;</span>&emsp;
					<a href="#" id="red_tea_main">牙刷2</a>&emsp;<span class="line">&#124;</span>&emsp;
					<a href="#" id="qing_tea_main">牙刷3</a>&emsp;<span class="line">&#124;</span>&emsp;
					<a href="#" id="hua_tea_main">牙刷4</a></div>
			</div>
