	...
	<div style="width: 100%; height: 100%; position: fixed;">
		<div style="width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center;">
			...
			<div style="width: 100%; height: 20%; display: flex; align-items: center; justify-content: center;">
				<p>例题所示的洗发水并没有在之前商品页面中出现过，因此选择“否”。所有的题目中的<strong>商品信息都是正确的</strong>，您只需要判断该商品是否出现过</p>
				<a id="next_phrase" href="#" style="width: 160px; height: 40px; text-align: center; border:2px solid black; font-size: 26px;">进入正式作答</a>
			</div>			
		</div>	
	</div>
`;