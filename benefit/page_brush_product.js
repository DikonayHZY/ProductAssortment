	...
	<div style="width: 100%; height: 100%; position: fixed;">
		...
		<div style="width: 100%; height: 80%; display: flex;"> <!-- 下半部分 -->
			<div style="width: 15%; height: 100%; min-width: 150px; /*background-color: green; */display: flex; align-items: center; justify-content: center;"> <!-- 左侧导航栏 -->
				<div class="brush_left_menu" style="width: 100%; height: 70%; display: flex; flex-direction: column; align-items: center; justify-content: center; border: black 1px solid;">
					<a href="#" id="left_green_tea">健康清洁</a><br>
					&emsp;<br>
					<a href="#" id="left_red_tea">抗敏护龈</a><br>
					&emsp;<br>
					<a href="#" id="left_qing_tea">杀菌祛斑</a><br>
					&emsp;<br>
					<a href="#" id="left_hua_tea">深层美白</a>
				</div>
			</div>
