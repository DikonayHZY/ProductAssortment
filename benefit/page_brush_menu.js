page_brush_menu =`
	<div style="width: 100%; height: 100%; position: fixed;">
		...
		<div style="width: 100%; height: 80%; display: flex; align-items: center; background:url(../resource/brush2.jpg); background-size: 100% 100%; background-repeat:no-repeat;"> <!-- 下半部分 -->
